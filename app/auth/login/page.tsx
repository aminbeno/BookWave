    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <blockquote className="text-white/90 text-xl font-light italic leading-relaxed mb-4 animate-fade-in-up">
            &ldquo;Un livre est un reve que vous tenez entre vos mains.&rdquo;
          </blockquote>
          <cite className="text-white/60 text-sm">— Neil Gaiman</cite>
        </div>
        <div className="relative z-10">
          <div className="grid grid-cols-3 gap-4">
            {[
              { icon: '📚', label: 'Ma bibliotheque' },
              { icon: '📊', label: 'Mes stats' },
              { icon: '🏆', label: 'Mes defis' },
            ].map((item, i) => (
              <div
                key={i}
                className="bg-white/10 rounded-xl p-3 text-white/80 text-sm text-center backdrop-blur-sm hover:bg-white/20 transition-all duration-300 hover:-translate-y-0.5 animate-fade-in"
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2 animate-fade-in stagger-2">Bon retour !</h1>
          <p className="text-muted-foreground mb-8 animate-fade-in stagger-3">Connectez-vous a votre bibliotheque</p>
